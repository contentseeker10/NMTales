...
namespace NMTales.Backend.Data
{
    ...
    public static class DbSeeder
    {
        ...
        private static IEnumerable<Question> GameUkrainianQuestions()
        {
            ...
            yield return Scroll("Lang_2", "Ми повинні писати слова правильно: [0], [1], [2], а також [3], [4] та [5].",
                ("пів'яблука", 0), ("прекрасний", 1), ("роздоріжжя", 2), ("священний", 3), ("духмяний", 4), ("агентство", 5),
                ("пів-яблука", null), ("прикрасний", null), ("роздоріжя", null), ("священий", null), ("духм'яний", null), ("агенство", null));

            yield return Scroll("Lang_2", "У диктанті зустрілися слова: [0], [1], [2] та [3], [4], [5].",
                ("медвяний", 0), ("міжгір'я", 1), ("тьмяний", 2), ("морквяний", 3), ("під'їзд", 4), ("Харків", 5),
                ("медв'яний", null), ("міжгіря", null), ("тмяний", null), ("моркв'яний", null), ("підїзд", null), ("Харьків", null));
